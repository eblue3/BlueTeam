...
.data
pinfo				PLUGIN_INFO <DUP2_PLUGIN_VERSION,"com.d2k2.backup_switch","[Backup Switch]","backup_switch.d2p">
...
DUP2_ModuleDescription proc uses esi edi ebx _plugin_data:DWORD
	...
	.if [esi].MY_PLUGIN_DATA_STRUCTURE.options & BACKUP_ON
		mov eax,chr$("Backup On")
	.else
		mov eax,chr$("Backup Off")	
	.endif
...
DialogPlugin proc uses ebx esi edi hwnd,message,wparam,lparam
	...
	.if eax==WM_INITDIALOG
		...
		mov hCOMBOBOX_BACKUP,eax
	        fn SendMessage,hCOMBOBOX_BACKUP,CB_ADDSTRING,0,"Off"	
	        fn SendMessage,hCOMBOBOX_BACKUP,CB_ADDSTRING,0,"On"
